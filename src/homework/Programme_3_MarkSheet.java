...
/**
 * Write a java programme to input student Name, roll NO, and three subjects
 * Math, Science and English marks( marks is between 0 to 100 and if it is out
 * of range print error message "Invalid Inupt, Marks should between 0 to 100" )
 * and find out total , percentage and result.
 * If he is pass or fail on basis of percentage (pass>=35) and also give them
 * grade if %> = 80 A+, %> = 60 A, %> = 50 B, %> = 35 C And print
 * Mark Sheet in following format
