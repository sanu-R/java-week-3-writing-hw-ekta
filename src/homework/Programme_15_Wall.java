 ...
 * with name <p> width and height of type double.
 * The class needs to have two constructors.The first constructor does have any
 * parameters (no arg constructor) The seond constructor has parameters width and
 * height of type double it needs to initialize the fields.
 ...
 * the value of the width field. If the parameter is less than 0 it needs to
 * set the width field value to 0.
